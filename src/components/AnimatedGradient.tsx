...
const WebGLErrorBoundary = ({ children, fallback }: { children: React.ReactNode; fallback: React.ReactNode }) => <>{children ?? fallback}</>;
const WebGLFallback = ({ className }: { className?: string }) => <div className={cn("bg-red-950", className)} />;
